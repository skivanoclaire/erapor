...
use App\Http\Controllers\ReportWaliSignatureController;
use App\Http\Controllers\ReportCustomizationController;
...
Route::resource('schools', SchoolController::class)->only(['show', 'edit', 'update']);
...
// Rencana penilaian per class_subject
...
// Daftar penilaian per class_subject
...
// Hitung nilai akhir per class_subject
...
Route::get('p5-projects/{p5}/ratings', [P5RatingController::class,'index'])->name('p5.ratings.index');               // pilih siswa
Route::get('p5-projects/{p5}/ratings/{student}', [P5RatingController::class,'edit'])->name('p5.ratings.edit');       // form per siswa
Route::post('p5-projects/{p5}/ratings/{student}', [P5RatingController::class,'update'])->name('p5.ratings.update');  // simpan
...
Route::get('extracurriculars/{ex}/members', [ExtracurricularMemberController::class,'index'])
    ->name('extracurriculars.members');

Route::post('extracurriculars/{ex}/members', [ExtracurricularMemberController::class,'store'])
    ->name('extracurriculars.members.store');

Route::post('extracurriculars/{ex}/members/add-all', [ExtracurricularMemberController::class,'storeAll'])
    ->name('extracurriculars.members.storeAll');

Route::delete('extracurriculars/{ex}/members/{member}', [ExtracurricularMemberController::class,'destroy'])
    ->name('extracurriculars.members.destroy');
...
// Report Settings (index, create, store, edit, update)
Route::get   ('report-settings',                     [ReportSettingController::class, 'index'])->name('report-settings.index');
Route::get   ('report-settings/create',              [ReportSettingController::class, 'create'])->name('report-settings.create');
Route::post  ('report-settings',                     [ReportSettingController::class, 'store'])->name('report-settings.store');
Route::get   ('report-settings/{report_setting}/edit',[ReportSettingController::class, 'edit'])->name('report-settings.edit');
Route::put   ('report-settings/{report_setting}',    [ReportSettingController::class, 'update'])->name('report-settings.update');

// (a) Wali signatures
Route::get   ('report-wali-signatures',                    [ReportWaliSignatureController::class,'index'])->name('rws.index');
Route::get   ('report-wali-signatures/create',             [ReportWaliSignatureController::class,'create'])->name('rws.create');
Route::post  ('report-wali-signatures',                    [ReportWaliSignatureController::class,'store'])->name('rws.store');
Route::get   ('report-wali-signatures/{rws}/edit',         [ReportWaliSignatureController::class,'edit'])->name('rws.edit');
Route::put   ('report-wali-signatures/{rws}',              [ReportWaliSignatureController::class,'update'])->name('rws.update');
Route::delete('report-wali-signatures/{rws}',              [ReportWaliSignatureController::class,'destroy'])->name('rws.destroy');

// (b) Report customizations
Route::get   ('report-customizations',                     [ReportCustomizationController::class,'index'])->name('rc.index');
Route::get   ('report-customizations/create',              [ReportCustomizationController::class,'create'])->name('rc.create');
Route::post  ('report-customizations',                     [ReportCustomizationController::class,'store'])->name('rc.store');
Route::get   ('report-customizations/{rc}/edit',           [ReportCustomizationController::class,'edit'])->name('rc.edit');
Route::put   ('report-customizations/{rc}',                [ReportCustomizationController::class,'update'])->name('rc.update');
Route::delete('report-customizations/{rc}',                [ReportCustomizationController::class,'destroy'])->name('rc.destroy');
...
// Monitor Penilaian (Daftar Penilaian)
...
// (opsional) export nanti: Route::get('daftar-legger/export', [LeggerController::class,'export'])->name('legger.export');
...
// (opsional) Hitung otomatis dari penilaian
